...
removeAllWithRecursion :: Int -> [Int] -> [Int]
removeAllWithRecursion n [] = []
removeAllWithRecursion n (x : xs)
     | x == n = removeAllWithRecursion n xs
     | otherwise = x : removeAllWithRecursion n xs

removeAllWithListComprehension :: Int -> [Int] -> [Int]
removeAllWithListComprehension n (x : xs) = [num | num <- (x : xs), num /= n]
...
countPos :: [Int] -> Int
countPos (x : xs) = length [n | n <- (x : xs), n >= 0]
