...
> -- Funcao sem parametro que retorna uma lista de booleanos
> bools :: [Bool]
> bools = [True, False, True]

> -- Funcao sem parametro que retorna uma lista de listas de inteiros
> nums  :: [[Int]]
> nums = [[1,3,4], [123,332,1231], []]

> -- Funcao que recebe 3 inteiros como parametro e retorna um inteiro
> add   :: Int -> Int -> Int -> Int
> add a b c = a + b + c

> -- Funcao que copia o parametro dado em um par dele mesmo
> copy  :: a -> (a, a)
> copy x = (x, x)

> -- Funcao que recebe uma funcao que tem como parametro a e retorna b e a aplica
> apply :: (a -> b) -> a -> b
> apply f x = f x

> -- Funcao que recebe um par e inverte a ordem de seus atributos
> swap  :: (a,b) -> (b,a)
> swap (a, b) = (b, a)
