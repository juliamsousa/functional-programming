...
perfectNumbersList :: Int -> [Int]
perfectNumbersList n = [x | x <- [1..n], isPerfect x]
...
calculateNormal :: (Double, Double) -> (Double, Double)
calculateNormal (x, y) = normal
  where
    v = sqrt (x^2 + y^2)
    x1 = x/v
    x2 = y/v
...
lengthPatternMatch :: [a] -> Bool
lengthPatternMatch [] = True
lengthPatternMatch [ _ ] = True
lengthPatternMatch [ _, _] = True
lengthPatternMatch _ = False

lengthNormal :: [a] -> Bool
lengthNormal list = (length list) <= 2
